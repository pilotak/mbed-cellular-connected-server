...
#if !defined(MDM_PWRON_pin)
    #define MDM_PWRON_pin PB_12
#endif
#if !defined(MDM_RST_pin)
    #define MDM_RST_pin PC_6
#endif
#if !defined(MDM_TX_pin)
    #define MDM_TX_pin PA_2
#endif
#if !defined(MDM_RX_pin)
    #define MDM_RX_pin PA_3
#endif
#if !defined(MDM_RTS_pin)
    #define MDM_RTS_pin PA_1
#endif 
#if !defined(MDM_CTS_pin)
    #define MDM_CTS_pin PA_0
#endif
